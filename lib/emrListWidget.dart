          ...
          content: Column(
            ...
            children: <Widget>[
              new LinearPercentIndicator(
                ...
                center: Text(document['scr'].toString()+'/100',
                  style: TextStyle(color: Colors.grey[100]),),
                progressColor: colorX,
                animationDuration: 2000,
              ),
              Text('This score is automatically generated from the Data collected'),
              Divider(color: Colors.grey[900],),
              Text(
                'To Improve Score: ', style: TextStyle(fontWeight: FontWeight.bold),),
      ...
      return Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Text('$loadSuggestionsList could not be captured from the audio.',style: TextStyle(color: Colors.grey),),
          )
        ],
      );
    else{
    ...
    if(loadSuggestionsApproval==1)
      return Column(
        ...
        children: <Widget>[
          ...
          Padding(
            padding: const EdgeInsets.fromLTRB(15.0,2.0,15.0,2.0),
            child: Text('Once the transcription is completed, we ask you to verify it and add relevant feedback.',style: TextStyle(color: Colors.grey),),
          )
        ],
      );
    else{
